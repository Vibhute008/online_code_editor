...
const GridCard = ({ item }) => {
  ...
  const deleteProj = (id) => {
    fetch(api_base_url + '/deleteProject', {
      ...
      .catch(() => {
        toast.error('An unexpected error occurred'); // Catch block for errors
        setIsDeleteModelShow(false);
      });
  };
  ...
  return (
    <>
      <div className="gridCard card bg-[#141414] w-[270px] p-[10px] h-[180px] cursor-pointer hover:bg-[#202020] rounded-lg shadow-lg shadow-black/50">
